        ...
        <>
            <div className="w-full h-24 shadow-2xl flex justify-between items-center px-10">
                ...
                <div className="flex items-center gap-10">
                    ...
                    <motion.div>
                        <DropdownMenu>
                            <DropdownMenuTrigger className="bg-white/80 cursor-pointer backdrop-blur-sm border border-gray-300/50 shadow-sm rounded-md px-4 py-2 w-24 text-center">
                            ...
                            <DropdownMenuContent className="bg-gray-500/20 backdrop-blur-lg mt-2 rounded-xl flex flex-col gap-2 border-none shadow-2xl w-40 p-2">
                                <DropdownMenuItem
                                    ...
                                    onSelect={() => i18n.changeLanguage('de')}>Deutsch
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    className="focus:bg-white/20 bg-white/80 rounded-md duration-400 p-2 cursor-pointer"
                                    onSelect={() => i18n.changeLanguage('en')}>English
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    className="focus:bg-white/20 bg-white/80 rounded-md duration-400 p-2 cursor-pointer"
                                    onSelect={() => i18n.changeLanguage('it')}>Italiano
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                    </motion.div>
